...
const endpoints = makeApi([
  {
    method: "get",
    path: "/teams/:team/images/:imageId",
    alias: "getTeamsTeamimagesImageId",
  ...
  {
    method: "post",
    path: "/teams/:team/images/upload",
    alias: "postTeamsTeamimagesupload",
...
export const Images___TeamsApi = new Zodios(endpoints);
