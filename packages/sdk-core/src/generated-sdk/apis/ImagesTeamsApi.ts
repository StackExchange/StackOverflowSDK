 ...
 * no description
 */
export class ImagesTeamsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param team 
     */
    public async teamsTeamImagesImageIdGet(imageId: string, team: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'imageId' is not null or undefined
        if (imageId === null || imageId === undefined) {
            throw new RequiredError("ImagesTeamsApi", "teamsTeamImagesImageIdGet", "imageId");
        }


        // verify required parameter 'team' is not null or undefined
        if (team === null || team === undefined) {
            throw new RequiredError("ImagesTeamsApi", "teamsTeamImagesImageIdGet", "team");
        }


        // Path Params
        const localVarPath = '/teams/{team}/images/{imageId}'
     ...
     * @param file 
     */
    public async teamsTeamImagesUploadPost(team: string, file?: HttpFile, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'team' is not null or undefined
        if (team === null || team === undefined) {
            throw new RequiredError("ImagesTeamsApi", "teamsTeamImagesUploadPost", "team");
        }



        // Path Params
        const localVarPath = '/teams/{team}/images/upload'
            .replace('{' + 'team' + '}', encodeURIComponent(String(team)));
...
export class ImagesTeamsApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to teamsTeamImagesImageIdGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async teamsTeamImagesImageIdGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to teamsTeamImagesUploadPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async teamsTeamImagesUploadPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ImageResponseModel >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
