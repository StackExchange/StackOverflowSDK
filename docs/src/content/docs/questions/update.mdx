...
```typescript
import StackOverflowSDK, { ValidationError, ForbiddenError, NotFoundError, AuthenticationError } from 'stack-overflow-sdk';
...
- **Team vs Public Context**: Updates work in both team and public contexts based on client initialization
