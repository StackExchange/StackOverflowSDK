...
```typescript
import StackOverflowSDK, { ForbiddenError, ConflictError, NotFoundError, AuthenticationError } from 'stack-overflow-sdk';
...
- **Team vs Public Context**: Voting works in both contexts but may have different community standards
