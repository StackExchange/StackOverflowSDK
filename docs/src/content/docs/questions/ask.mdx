---
title: ask()
description: Creates a new question with title, body content, and associated tags. Works in both public and team contexts.
---

# ask()

Creates a new question with title, body content, and associated tags. Works in both public and team contexts.
...
- **Permissions**: Users must have appropriate permissions to create questions in the target context (public or team)