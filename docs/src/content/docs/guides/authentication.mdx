...
### For Public Stack Overflow for Teams
...
const teamsSDK = new StackOverflowSDK({
  baseUrl: 'https://your-site.stackenterprise.co',
  accessToken: 'your-teams-access-token'
});

// For public Stack Overflow
const publicSDK = new StackOverflowSDK({
...
- [Questions API](/api/questions) - Learn about fetching questions
- [Error Handling](/guides/error-handling) - Implement robust error handling
