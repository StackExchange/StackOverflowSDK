 ...
 * no description
 */
export class SearchMainApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param sort 
     */
    public async searchGet(query?: string, page?: number, pageSize?: 15 | 30 | 50 | 100, sort?: SearchSortParameter, _options?: Configuration): Promise<RequestContext> {
...
export class SearchMainApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to searchGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async searchGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<PaginatedSearchResults >> {
